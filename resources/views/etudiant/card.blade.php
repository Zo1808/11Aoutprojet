...
<section class="content">
 <!--   <div class="box box-default">
        <div class="box-body">
            <div class="row">
                <div class="col-md-10">
                <div style="top-bar-title padding-bottom margin-left:-900px;margin-top:15px;"><img src="{{$UM}}" height="80px;"width="80;"alt="logo"></img>
               ...
               <img src="" style="margin-left:290px;margin-top:-90px" height="80px;"width="80;"alt="logo"></img>
              ...
              <!--<table cellpadding="0" cellspacing="0" border="1" width="100%;" >
               ...
               <div class="col-md-3">
                <div style="top-bar-title"><img src="{{$IESSI}}" style="margin-top:12px" height="80px;"width=""alt="logo"></img></div>
               </div>
 			   </td>
                <td style="margin-right:50%">ccccccccc</td>
                </tr>
                  <tr>
                   <td colspan="3">UE</td>
                    <td>Nom Matière</td>
                  ...
                  <tr>
                  	 <td>  <div style="top-bar-title padding-bottom margin-left:-900px;margin-top:15px;"><img src="{{$UM}}" height="80px;"width="80;"alt="logo"></img>
					</td>
                  	 <td style="margin-right:"113px;">&nbsp &nbsp &nbsp UNIVERSITE D'ANTANANARIVO <br/>INSTITUT D'ENSEIGNEMENT SUPERIEUR<br>
&nbsp &nbsp &nbsp DE SOAVINANDRIANA ITASY</td>
                  	 <td> <div style="top-bar-title"><img src="{{$IESSI}}" class="pull-right" style="margin-top:12px" height="80px;"width=""alt="logo"></img></div></td>
                  	 <td colspan="6">VISITE MEDICALE</td>
              ...
              {{csrf_field()}}
              <input type="hidden" name="et_id" value="">
              <input type="hidden" name="type_exam_id" value="">
             <center>
