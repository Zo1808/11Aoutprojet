    ...
    <div class="box box-default">
        <div class="box-body">
            <div class="row">
                ...
                <div class="col-md-10">
                <center>
                 <div class="top-bar-title padding-bottom" style="margin-left:20px;margin-top:-80px;"><b>
                REPOBLIKAN'I MADAGASIKARA<br>
&nbspFitiavana-Tanindrazana-Fandrosoana<br>
                     UNIVERSITE D'ANTANANARIVO<br/>INSTITUT D'ENSEIGNEMENT SUPERIEUR<br>
          DE SOAVINANDRIANA ITASY
                </div><br></b>
            <h4 style="font-style:oblique;font-family: fantasy;">
                FICHE DE PRESENCE <br/>
                      {{App\Filieres::select('nom')->where('id',$filiere_id)->first()->nom}} {{App\Classes::select('nom_classe')->where('id',$classe_id)->first()->nom_classe}} &nbsp {{$annee_scolaire}}
                    </h4>
                </center>
                ...
                <div style="top-bar-title"><img src="{{$IESSI}}" style="margin-left:600px;margin-top:-190px" height="80px;"width="80;"alt="logo"></img></div>
            </div>
        </div>
    </div>
      <!-- Default box -->
