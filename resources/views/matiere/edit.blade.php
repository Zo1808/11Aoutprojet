    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-default">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <form action="{{url('matiere')}}/{{$matieres}}" method="POST" id="demandForm" enctype="multipart/form-data">
                        {{csrf_field()}}
                        {{method_field('PUT')}}
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nom_matiere" id="nom_matiere" class="form-control" value='{{$nom_matiere}}'>
                                </div>
                                <!-- /.form-group -->
                            </div>
                         </div>
                         <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" min="1" name="coeff" id="coeff" class="form-control"value='{{$coeff}}'>
                                </div>
                                <!-- /.form-group -->
                            </div>
                         </div>
