...
<div class="box box-default">
        <div class="box-body">
            <div class="row">
                <div class="col-md-12">
                    <div class="top-bar-title padding-bottom"><center><h3>Ajouter de commentaire</h3></center/></div>
                </div>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-default">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <form action="{{route('comment.store')}}" method="POST" id="demandForm" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="row">
                            <div class="col-md-12">
                                <!-- /.form-group -->
                    ...
                    <div class="col-md-12">
                                <!-- /.form-group -->
                                <div class="form-group">
                                    <label class="require control-label">Commentaire</label>
                       ...
                       <button class="pull-right btn btn-primary">Ajouter Maintenant</button>
                  </form>
